...
const Home = () => {
    ...
    try {
      ...
      if (response.data && response.data.note) {
        !noteData.isPinned
          ...
          : handleShowToast("Note Unpinned Successfully");
        getAllNotes();
      }
    } catch (error) {
      console.log(error);
  ...
  return (
    <>
            ...
            {allNotes.map((item, index) => {
              return (
                <NoteCard
                  ...
                  onViewNote={() =>
                    setViewNotesModal({ isShown: true, data: item })
                  }
                />
              );
            })}
      ...
      >
        <ViewNotes
          noteData={viewNotesModal.data}
          onClose={() => {
            setViewNotesModal({ isShown: false, data: null });
          }}
          getAllNotes={getAllNotes}
        />
      </Modal>
